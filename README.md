...
- Actualizar una página con un titulo mayor a 255 carácteres
- Creación página y actualizar la url para visualizarla
- Creación página con mal formato de fecha
- Creación de Página con un extracto mayor a 300 carácteres
- Creación de Página con tag
- Creación de Página con meta data Title con mas de 300 carácteres
- Creación de Página con meta data Description con mas de 500 carácteres
- Creación de Página con canonical URL invalida
- Creación de Página con canonical URL con mal formato
- Creación de Página con canonical URL con más de 2000 caracteres
- Creación de Página con Twitter card description con más de 500 carácteres
- Creación de Página con Twitter card con data correcta
- Creación de Página con Facebook card title con más de 300 carácteres
- Creación de Página con Facebook card description con más de 500 carácteres
- Creación de Página con Facebook card con data correcta
- Publicar dos Páginas con el mismo titulo
- Programar Publicación de un Página con fecha anterior a la actual
- Publicar Página con contenido publico y solo para miembros
- Publicar Página con titulo de solo Emojis
- Publicar Página con page Url de solo Emojis no se puede crear
- Creación de Página con Meta data Title de solo emojis
- Creación de una pagina Meta data Description con solo Emojis

### Dinámicos implementados con Api Mockaro
- Creación de Página con Twitter card title con más de 300 carácteres
- Creación de Página con Facebook data Title de solo emojis
- Creación de Página con Twitter data Title de solo emojis
- Creación de Página con Facebook data Description de solo emojis

### Aleatorios implementados con Faker
- Creación página pero sin publicarla
- Creación página y publicarla
- Borrado de página recién creada
- Creación página y cancelar su creación
